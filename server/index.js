    ...
    [
      {
        fields: {
          ...
          "Tipo de superficie descubierta": req.body.tipoSuperficie.id,
          ...
          "Precio Inicial Historico - USD":
            !req.body.precioInicialPeso && req.body.montoPrecioHistorico !== ""
          ...
          "Ultimo Precio Publicado - USD":
            !req.body.ultimoPrecioPeso && req.body.montoUltimoPrecio !== ""
